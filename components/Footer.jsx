        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-1">
            <div className="flex items-center mb-4 space-x-2">
              <span className="footer-brand-btn footer-brand-credvix font-bold">Credvix</span>
              <span className="text-gray-500">|</span>
              <span className="footer-brand-btn footer-brand-help font-bold">Help!</span>
            </div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/credvix.oficial/?locale=pt_BR" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="social-icon">
              ...
              <a href="https://www.instagram.com/credvix/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="social-icon">
              ...
              <a href="https://br.linkedin.com/company/credvix" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="social-icon">
          ...
          <div className="col-span-1">
            <h3 className="font-semibold text-lg mb-4 text-white uppercase tracking-wider">Links Rápidos</h3>
            <ul className="space-y-3 text-gray-400">
              <li><Link href="/#quem-somos" className="hover:text-white transition-colors">Quem Somos</Link></li>
              <li><Link href="/#perguntasFrequentes" className="hover:text-white transition-colors">Perguntas Frequentes</Link></li>
              <li><Link href="/lojas" className="hover:text-white transition-colors">Nossas Lojas</Link></li>
              <li><Link href="/vagas" className="hover:text-white transition-colors">Trabalhe Conosco</Link></li>
            </ul>
          </div>

          <div className="col-span-1 md:col-span-2 lg:col-span-2">
            <h3 className="font-semibold text-lg mb-4 text-white uppercase tracking-wider">Contato</h3>
            <ul className="space-y-4 text-gray-400">
              <li className="flex items-start">
                <span className="material-icons mr-3 mt-1 text-credvix-orange flex-shrink-0">location_on</span>
                <span>Presente em 6 Estados do Brasil</span>
              </li>
              <li className="flex items-center">
                <span className="material-icons mr-3 text-credvix-orange">email</span>
                <a href="mailto:contato@credvix.com" className="hover:text-white transition-colors">contato@credvix.com</a>
              </li>
              <li className="flex items-center">
                <span className="material-icons mr-3 text-credvix-orange">call</span>
                <a href="tel:+552730208584" className="hover:text-white transition-colors">(27) 3020-8584</a>
              </li>
              <li className="flex items-start">
                <span className="material-icons mr-3 mt-1 text-credvix-orange flex-shrink-0">schedule</span>
