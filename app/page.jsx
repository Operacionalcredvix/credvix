          ...
          <div className="text-center mt-16 md:mt-24">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 max-w-6xl mx-auto">
              <div className="value-card">
                ...
                </div><span className="font-semibold">Respeito</span>
              </div>
              <div className="value-card">
                <div className="value-icon">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                </div><span className="font-semibold">Honestidade</span>
              </div>
              <div className="value-card">
                <div className="value-icon">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                </div><span className="font-semibold">Dedicação</span>
              </div>
              <div className="value-card">
                <div className="value-icon">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                </div><span className="font-semibold">Comprometimento</span>
              </div>
              <div className="value-card">
                <div className="value-icon">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                </div><span className="font-semibold">Profissionalismo</span>
              </div>
            </div>
          </div>
        </div>
